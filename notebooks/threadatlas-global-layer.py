...
# ## What goes out
#
# `threadatlas.sqlite`, `threadatlas.npy`, `build.sqlite`, `calls.jsonl`, `receipt.json`, `questions.jsonl` and the
# wiki pages in the output folder.
#
# ## The store
#
...
# ## Block 20: retrieval
#
# The query path of `log/2026-09-15/retrieval.md` with its section 11 corrections. Two entry
...
# %% [markdown]
# ## Block 21: a question over the largest collection
#
