# %% [markdown]
# # ThreadAtlas ingestor: one document at a time, from the extractor's export to a document package
#
...
#
# **On Kaggle:** attach the export dataset (`jhffmn/it494-threadatlas-step0`) and, for the
...
INGESTOR = "threadatlas-ingestor 0.8"
