...
| 4 | Oct 26 to 31 | 2g; the parent-off arm; what the batches showed folded into the dataset; the wiki pages over document clusters (one afternoon) | results | **Oct 31: build stop** |
