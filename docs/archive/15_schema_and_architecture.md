> **SUPERSEDED 2026-08-28** by `03_design.md` (schema and architecture) and `07_references.md` (prior art). Its quality pass drove those documents; items 3 and 4 of it were unabsorbed until 08-28 and are now open questions in `03_design.md`.
